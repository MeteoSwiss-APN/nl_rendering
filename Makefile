...
VENV_NAME ?= nl_rendering#OPT Name of conda virtual environment (overridden by VENV_DIR)

# Default values used below (caution: keep values in sync with above)
DEFAULT_VENV_NAME = nl_rendering#
...
#	\rm -f docs/nl_rendering.rst
#	\rm -f docs/modules.rst
#	${PREFIX}sphinx-apidoc -o docs/ src/nl_rendering
#	$(MAKE) -C docs clean
#	$(MAKE) -C docs html
